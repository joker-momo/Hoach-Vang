// admin.js
// Phiên admin: nhập password -> verify server-side (RPC) -> quyền admin 30 phút -> tự về read-only.

const ADMIN_STORAGE_KEY = "minhfat_admin";
...
const admin = {
  ...
  _expiry: 0,
  _timer: null,
  onChange: null, // callback(isAdmin) khi trạng thái admin đổi (để re-render UI)
